...
# Function to refresh data if it's a new day
...
bg_image = Image.open(r"C:\Users\marvx\Downloads\360_F_522331099_Ha6ktAQY8ghcAR8PAqAqeKZZLRPm5g5W.jpg")  # Replace with your starry background image path
bg_image = bg_image.resize((800, 600), Image.Resampling.LANCZOS)  # Resize to match window size
bg_image.save("temp_bg_image.png")
bg_img_tk = tk.PhotoImage(file="temp_bg_image.png")
bg_label = tk.Label(root, image=bg_img_tk)
bg_label.place(x=0, y=0, relwidth=1, relheight=1)

# Set moon logo
logo_image = Image.open(r"C:\Users\marvx\Downloads\pvipb16mkliz.png")  # Replace with your moon logo image path
logo_image = logo_image.resize((100, 100), Image.Resampling.LANCZOS)  # Resize the logo
logo_img_tk = tk.PhotoImage(file=r"C:\Users\marvx\Downloads\pvipb16mkliz.png")
...
def create_apod_window():
    ...
    title_label = tk.Label(apod_window, text="", font=("Helvetica", 16, "bold"))
    title_label.pack(pady=10)

    explanation_label = tk.Label(apod_window, text="", wraplength=800, font=("Helvetica", 12), justify="left")
...
# Space History Window
def create_history_window():
    history_window = tk.Toplevel(root)
    history_window.title("This Day in Space History")

    history_label = tk.Label(history_window, text="", wraplength=800, font=("Helvetica", 12), justify="left")
...
# Automatically refresh data on startup
